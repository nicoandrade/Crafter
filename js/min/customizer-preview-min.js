...
( function( $ ) {
	...
	// Logo
	wp.customize( 'crafter_logo', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				var logo = '<img src="' + to + '" />';
    ...
    */
    	...
    	------------------------------ */
    	//Quote
		wp.customize( 'crafter_quote', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-wrap blockquote' ).text( to );
			} );
		} );
		//Quote Author
		wp.customize( 'crafter_quote_cite', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-cite' ).html( to );
			} );
		} );
		//Quote Image
		wp.customize( 'crafter_quote_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "") {
					$.ajax({
		...
		//Background Color
		wp.customize( 'crafter_quote_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.quote-background' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'crafter_quote_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.quote-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Featured Image
		wp.customize( 'crafter_image_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
    	...
    	//Title
		wp.customize( 'crafter_image_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text .image-text-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'crafter_image_text', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text p' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Link Title
		wp.customize( 'crafter_image_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'crafter_image_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'crafter_image_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.image-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Phone Image
		wp.customize( 'crafter_phone_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
					$.ajax({
						url: wp_customizer.ajax_url,
		...
		//Link Title
		wp.customize( 'crafter_phone_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'crafter_phone_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'crafter_phone_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section' ).css( 'background-color', to );
			} );
		} );
		//Phone Color
		wp.customize( 'crafter_phone_color', function( value ) {
			value.bind( function( to ) {
				if ( to == "gray" ) {
		...
		//Enable/Disable Section
		wp.customize( 'crafter_phone_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.phone-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'crafter_tagline_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section .tagline' ).text( to );
			} );
		} );
		//Sub-text
		wp.customize( 'crafter_tagline_sub_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section span' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'crafter_tagline_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section a' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'crafter_tagline_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'crafter_tagline_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'crafter_map_title', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .section-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'crafter_map_text', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .map-text' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'crafter_map_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.map-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'crafter_subscribe_title', function( value ) {
			value.bind( function( to ) {
				$( '.subscribe-section .section-title' ).text( to );
			} );
		} );
		//Background Image
		wp.customize( 'crafter_subscribe_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
					$( '.subscribe-section' ).css( 'background-image', 'url(' + to + ')' );		
				}else{
					$( '.subscribe-section' ).css( 'background-image', 'url(' + wp_customizer.theme_url + "/images/subscribe.jpeg)" );
				}
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'crafter_subscribe_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
