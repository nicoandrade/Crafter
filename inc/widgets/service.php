...
add_action('admin_enqueue_scripts', 'crafter_service_widget_scripts');

function crafter_service_widget_scripts(){

    wp_enqueue_media();

    wp_enqueue_script( 'crafter_service_widget_script', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );

}


class crafter_Service extends WP_Widget{
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_attr__( 'Crafter - Service widget', 'crafter' ), // Name
            array( 
                'description' => esc_attr__( 'Display a Service or Feature description.', 'crafter' ),
            )
        );
    }
    ...
    public function widget( $args, $instance ){
        ...
        <?php if( ! empty( $instance['category'] ) ): ?>
            <div class="service-category"><?php echo esc_html( $instance['category'] ); ?> <span></span></div>
        <?php endif; ?>
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e( 'Text', 'crafter' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('category'); ?>"><?php esc_html_e( 'Category', 'crafter' ); ?></label><br/>

            <input type="text" name="<?php echo $this->get_field_name('category'); ?>"
                   id="<?php echo $this->get_field_id('category'); ?>" value="<?php if( !empty( $instance['category'] ) ): echo $instance['category']; endif; ?>"
                   class="widefat"/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('link'); ?>"><?php esc_html_e( 'Link','crafter' ); ?></label><br />
...
register_widget( 'crafter_Service' );
